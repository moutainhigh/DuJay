...
public interface HttpStatus {
    ...
    /** {@code 1000-1100 Data Server Error } */
    public static final int DATA_SOURCE_IS_NULL = 1000;
    public static final int DATA_SOURCE_NAME_ALREADY_EXISTED = 1001;
    public static final int DATA_SOURCE_NOT_ID_NULL= 1002;
    public static final int DATA_SOURCE_IS_USED = 1003;
    public static final int DATA_SOURCE_PARAM_MISSING = 1004;
    public static final int DATA_SOURCE_ENCRYPT_ERROR = 1005;

    /** {@code 100000-110000 Data Server Error } */
    public static final int USERNAME_PASSWORD_ERROR = 100000;
    public static final int IP_PORT_ERROR = 100001;
    public static final int DATABASE_NAME_ERROR = 100002;
    public static final int JDBC_URL_IS_NULL = 100003;
    public static final int DB_CONNECTION_ERROR = 100001;
    public static final int JDBC_ORAClE_DATABASE_ADDRESS_ERROR = 100005;

    public static final int MYSQL_TABLE_NAME_ERROR = 100010;
    public static final int MYSQL_SQL_ERROR = 100011;
    public static final int MYSQL_COLUMN_ERROR = 100012;
    public static final int MYSQL_AUTH_ERROR = 100013;
    public static final int MYSQL_WHERE_PARSE_ERROR = 100014;
    public static final int MYSQL_SPLIT_PK_ERROR = 100015;
    public static final int MYSQL_INSERT_ERROR = 100016;
    public static final int MYSQL_UPDATE_ERROR = 100017;
    public static final int MYSQL_DELETE_ERROR = 100018;

    public static final int SET_SESSION_ERROR = 100100;
    public static final int SET_RESULT_SET_ERROR = 100101;
    public static final int WRITE_DATA_ERROR= 100103;
    public static final int SET_CONNECTION_CLOSED_ERROR= 100104;
}
