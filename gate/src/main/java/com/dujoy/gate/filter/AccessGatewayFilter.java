package com.dujoy.gate.filter;

import com.alibaba.fastjson.JSONObject;
import com.dujoy.gate.handler.RequestBodyRoutePredicateFactory;
import com.dujoy.gate.service.LogService;
...
import com.enn.ygyg.common.constant.RedisKeyConstant;
import com.enn.ygyg.common.context.BaseContextHandler;
import com.enn.ygyg.common.exception.auth.UserTokenException;
import com.enn.ygyg.common.msg.BaseResponse;
import com.enn.ygyg.common.msg.auth.TokenForbiddenResponse;
...
public class AccessGatewayFilter implements GlobalFilter {
    ...
    public Mono<Void> filter(ServerWebExchange serverWebExchange, GatewayFilterChain gatewayFilterChain) {
        ...
        Mono<CheckPermissionInfo> checkPermissionInfoMono = webClientBuilder.build().
                get().uri("http://admin/api/user/{username}/check_permission?requestMethod=" + method + "&requestUri=" + requestUri, user.getUniqueName()).header(userAuthConfig.getTokenHeader(), BaseContextHandler.getToken()).retrieve().bodyToMono(CheckPermissionInfo.class);
